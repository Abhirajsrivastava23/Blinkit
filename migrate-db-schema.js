...
async function migrate() {
  ...
  try {
    ...
    const columnAdditions = [
      ...
      { table: 'products', column: 'subCategory', type: 'VARCHAR(255)' },
      { table: 'products', column: 'discount', type: 'NUMERIC DEFAULT 0' },
      { table: 'products', column: 'deliveryTime', type: 'VARCHAR(255)' },
      { table: 'products', column: 'ingredients', type: 'JSONB' },
      { table: 'products', column: 'allergens', type: 'JSONB' },
      { table: 'products', column: 'storageInstructions', type: 'TEXT' },
      { table: 'products', column: 'occasions', type: 'JSONB' },
      { table: 'products', column: 'variants', type: 'JSONB' },
      { table: 'products', column: 'wellnessBrand', type: 'VARCHAR(255)' },
      { table: 'products', column: 'wellnessType', type: 'VARCHAR(255)' },
      { table: 'products', column: 'wellnessMaterial', type: 'VARCHAR(255)' },
      { table: 'products', column: 'wellnessPackSize', type: 'VARCHAR(255)' },
      { table: 'products', column: 'wellnessTexture', type: 'VARCHAR(255)' },
      { table: 'products', column: 'wellnessFlavor', type: 'VARCHAR(255)' },
      { table: 'products', column: 'wellnessVerified', type: 'BOOLEAN DEFAULT TRUE' },
      { table: 'products', column: 'wellnessSku', type: 'VARCHAR(255)' },
      { table: 'products', column: 'wellnessDetails', type: 'JSONB' },
      { table: 'products', column: 'reviewCount', type: 'INTEGER DEFAULT 0' },
      { table: 'products', column: 'createdAt', type: 'VARCHAR(255)' },
      { table: 'products', column: 'updatedAt', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'customerEmail', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'updatedAt', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'deliveryTimeSlot', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'deliveryLocationId', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'deliveryLocationName', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'deliveryOtp', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'otpFailedAttempts', type: 'INTEGER DEFAULT 0' },
      { table: 'orders', column: 'otpExpiresAt', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'statusHistory', type: 'JSONB' },
      { table: 'orders', column: 'assignedPartnerId', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'assignedPartnerName', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'assignedAt', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'couponCode', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'delivery_otp_verified', type: 'BOOLEAN DEFAULT FALSE' },
      { table: 'orders', column: 'otp_verified_at', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'verified_by_partner_id', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'delivery_completed_at', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'adminOverride', type: 'JSONB' },
      { table: 'orders', column: 'paymentId', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'utr', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'proofImageUrl', type: 'TEXT' },
      { table: 'orders', column: 'paymentSubmittedAt', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'paymentVerifiedAt', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'paymentRejectedAt', type: 'VARCHAR(255)' },
      { table: 'orders', column: 'rejectionReason', type: 'TEXT' }
    ];
