...
export async function POST(request: Request) {
  try {
    ...
    const mockOrder = {
      ...
      paymentStatus: 'PAID',
      deliveryOption: 'Delivery within 24 hours',
      deliveryTimeSlot: 'Within 24 hours',
      eta: 'Delivery within 24 hours',
      assignedPartnerName: 'Rohan Verma (FATAFAT Delivery Partner #41)',
      address: {
